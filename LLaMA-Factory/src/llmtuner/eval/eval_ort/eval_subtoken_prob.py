...
@torch.no_grad()
def eval_subtoken_forget_prob(model, tokenizer, level1, level2, level3, batch_size=1, output_result_dir=None, use_prompt=False):
    ...
    for sample in level1:
        ...
        #     prompt_char_atk = direct_answer_instruction + prompt_char_atk
    ...
    for sample in level3:
        ...
        if sample['type'] == 'affirmative suffix':
            base_prompt_content = "Please briefly answer the following question.\nQuestion: {}".format(query)
        ...
        prompt_char_atk = chosen_template.format(base_prompt_content)
        ...
        level3_targets.append(answer_char)
    ...
    return level1_avg_prob, level2_avg_prob, level3_avg_prob, avg_acc_level1, avg_acc_level2, avg_acc_level3
