...
def run_pdt(
    ...
    with torch.no_grad():
        ...
        print("Evaluate subtoken forget gen...")
        eval_subtoken_forget_gen(model, e_tokenizer, forget_level1, forget_level2, forget_level3, batch_size=1,
                                 output_result_dir=os.path.join(output_result_dir, 'subtoken_forget_gen.json'), use_prompt=data_args.use_prompt)
        ...
        eval_forget_prob(model, e_tokenizer, forget_level1, forget_level2, forget_level3, batch_size=1,
                         output_result_dir=os.path.join(output_result_dir, 'forget_prob.json'), use_prompt=data_args.use_prompt)

        # print("Evaluate exploit gen...")
        # eval_exploit_gen(model, e_tokenizer, forget_level1, forget_level2, forget_level3, batch_size=1,
        #                  output_result_dir=os.path.join(output_result_dir, 'exploit_gen.json'), use_prompt=data_args.use_prompt)
        ...
        eval_neighbor_prob(model, e_tokenizer, neighbor_level1, neighbor_level2, batch_size=1,
